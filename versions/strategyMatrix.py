...
def list_distro_files():
    try:
        return [
            ...
            if (filename.startswith("sles_12.5") or filename.startswith("sles_15.3") or filename.startswith("sles_15.4") or filename.startswith("sles_15.5") or filename.startswith("amazonlinux_2"))
